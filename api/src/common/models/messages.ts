...
import { GameClientAction, GameServerEvent } from "./game"

type MotionMinhayaWSClientMessageBase = {
  action: GameClientAction
}

export type MotionMinhayaWSClientMessage = MotionMinhayaWSClientMessageBase & {
  action: "PING"
} | {
...
export type MotionMinhayaWSServerMessage = MotionMinhayaWSServerMessageBase & {
  event: "PONG"
} | {
  event: "PONG_WITH_ACK"
  message: string
